...
export default function NewBlogPostPage() {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    createPost({
      ...
      coverImage: form.coverImage.trim() || `https://picsum.photos/seed/${Date.now()}/800/450`,
        ...
        <div className="bg-white dark:bg-slate-900 rounded-xl border border-slate-200 dark:border-slate-800 p-6 md:p-8">
          {success ? (
            <div className="text-center py-12">
              ...
              <h2 className="text-xl font-semibold text-slate-900 dark:text-white mb-1">Post Created!</h2>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div>
                ...
                <input
                  ...
                  placeholder="e.g. The Best AI Tools in 2026"
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                  ...
                  <input
                    ...
                    placeholder="AI, Development, Productivity"
                    className="w-full px-4 py-2.5 bg-slate-50 dark:bg-slate-800 border border-slate-200 dark:border-slate-700 rounded-lg text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:ring-2 focus:ring-teal-500 text-sm transition"
                  />
                </div>
                <div>
              ...
              <div className="flex gap-3 pt-2">
                <button
                  type="submit"
                  className="flex-1 py-3 bg-gradient-to-r from-teal-500 to-cyan-500 text-white rounded-lg font-semibold hover:from-teal-600 hover:to-cyan-600 transition shadow-sm"
                >
                  Create Post
                </button>
                <Link
